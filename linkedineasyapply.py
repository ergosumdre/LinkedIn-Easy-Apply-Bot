...
class LinkedinEasyApply:
    ...
    def login(self):
        try:
            ...
            self.browser.find_element(By.XPATH, "//*[@id='username']").send_keys(self.email)
    ...
    def apply_jobs(self, location):
        ...
        try:
            ...
            job_list = self.browser.find_elements(By.CLASS_NAME, 'scaffold-layout__list')[0].find_elements(By.CLASS_NAME,'jobs-search-results__list-item')
        except:
            raise Exception("No more jobs on this page")
